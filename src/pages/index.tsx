...
export default function Login() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center text-white p-4">
      ...
      <div className="max-w-prose">
        ...
        <p className="text-center mb-4">Always HFWI and when you stop having fun with it stop.</p>
      </div>
      <div className="bg-green-500 text-white font-bold py-2 px-4 rounded-full cursor-pointer mb-8" onClick={() => (window.location.href = login_url)}>
        Log In With Spotify
      </div>
